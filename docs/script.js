...
async function predict() {
    isFrozen = true; // 冻结摄像头画面
    document.getElementById('restore-btn').disabled = false; // 启用还原按钮
...
function restoreWebcam() {
    isFrozen = false; // 解除冻结状态
    window.requestAnimationFrame(loop); // 恢复循环更新
    document.getElementById('restore-btn').disabled = true; // 禁用還原按鈕
}
